...
var _minond$brainloller$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {work: a, activeCmd: b, runtime: c, boardDimensions: d, zoomLevel: e, writeEnabled: f};
	});
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('w-100 w-50-l pr4-l'),
					_1: {ctor: '[]'}
				},
				A2(
					_elm_lang$core$Basics_ops['++'],
