...
var _minond$brainloller$Main$update = F2(
	function (message, model) {
		...
		switch (_p3._0.ctor) {
			...
			case 'IncreaseSize':
				var _p17 = _p3._1.boardDimensions;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
if (typeof _minond$brainloller$Main$main !== 'undefined') {
    _minond$brainloller$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Redo":[],"WriteCmd":["Int","Int","Bool"],"DecreaseSize":[],"ZoomIn":[],"ZoomOut":[],"EnableWrite":[],"UploadFile":[],"Reset":[],"Undo":[],"SetCmd":["Brainloller.Lang.BLOptCode"],"NoOp":[],"DisableWrite":[],"IncreaseSize":[]}}},"aliases":{"Brainloller.Lang.BLOptCode":{"args":[],"type":"String"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
