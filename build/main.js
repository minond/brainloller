...
var _minond$brainloller$Brainloller_Lang$BLEnvironment = F2(
	function (a, b) {
		return {runtime: a, program: b};
	});
var _minond$brainloller$Brainloller_Lang$BLRuntime = F7(
...
var _minond$brainloller$Brainloller_Program$progFib = {
	ctor: '::',
	_0: {
		ctor: '::',
		_0: {r: 0, g: 255, b: 0},
...
var _minond$brainloller$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {work: a, activeCmd: b, runtime: c, boardDimensions: d, zoomLevel: e, interpreterSpeed: f, writeEnabled: g};
	});
		...
		if (_p2.ctor === 'Just') {
			return A2(
				...
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Output: ', _p2._0)),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('fl w-100 w-50-l pr4-l'),
							_1: {ctor: '[]'}
						},
						A2(
							_elm_lang$core$Basics_ops['++'],
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fl w-100 w-50-l pl4-l mt3 mt0-l'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('editor-section fl w-100 w-50-l pr4-l'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _minond$brainloller$Elem$textCopy(_minond$brainloller$Main$introText1),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('editor-section fl w-100 w-50-l pl4-l'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _minond$brainloller$Elem$textCopy(_minond$brainloller$Main$introText2),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _minond$brainloller$Main$initialModel = {
	...
	runtime: _minond$brainloller$Brainloller_Lang$createRuntime(_elm_lang$core$Maybe$Nothing),
		...
		switch (_p3._0.ctor) {
			...
			case 'LoadMemoryProgram':
				var program = function () {
					...
					switch (_p4) {
						case 'helloworld.png':
							return _minond$brainloller$Brainloller_Program$progHelloWorld;
						case 'fib.png':
							return _minond$brainloller$Brainloller_Program$progFib;
						default:
							return {ctor: '[]'};
					}
				}();
				var runtime = _minond$brainloller$Brainloller_Lang$createRuntime(_elm_lang$core$Maybe$Nothing);
				return {
					ctor: '_Tuple2',
			...
			case 'SetSpeed':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{interpreterSpeed: _p5}),
					_1: _minond$brainloller$Ports$setInterpreterSpeed(_p5)
				};
			case 'Pause':
				return {
					ctor: '_Tuple2',
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							zoomLevel: 1,
							boardDimensions: _minond$brainloller$Brainloller_Pixel$programDimensions(_p6)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Undo':
				...
				switch (_p7.ctor) {
					...
					default:
						var _p11 = _p7._2;
						var _p10 = _p7._1;
						var newForw = {ctor: '::', _0: _p10, _1: _p11};
						var update = function () {
							var _p9 = _p7._0;
							if (_p9.ctor === '[]') {
								return A3(
								...
								if (_p9._1.ctor === '[]') {
									...
									return A3(_minond$brainloller$Main$BackCurrForw, _p9._1, _p9._0, newForw);
								}
							}
						}();
						return {
			...
			case 'Redo':
				var _p12 = _p3._1.work;
				if (_p12.ctor === 'BackCurrForw') {
					var _p15 = _p12._1;
					var _p14 = _p12._0;
					var newBack = {ctor: '::', _0: _p15, _1: _p14};
					var update = function () {
						var _p13 = _p12._2;
						if (_p13.ctor === '[]') {
							return A2(_minond$brainloller$Main$BackCurr, _p14, _p15);
						} else {
							if (_p13._1.ctor === '[]') {
								return A2(_minond$brainloller$Main$BackCurr, newBack, _p13._0);
							} else {
								return A3(_minond$brainloller$Main$BackCurrForw, newBack, _p13._0, _p13._1);
							}
						}
					}();
					return {
			...
			case 'WriteCmd':
				if (_p3._2.ctor === 'Just') {
					...
					var resized = rewrite ? A3(_minond$brainloller$Brainloller_Pixel$resizeProgram, program, _p18, _p19) : program;
					var update = function () {
						var _p16 = {
							ctor: '_Tuple2',
							_0: rewrite,
							_1: A3(_minond$brainloller$Brainloller_Pixel$getCellMaybe, resized, _p18, _p19)
						};
						if (((_p16.ctor === '_Tuple2') && (_p16._0 === true)) && (_p16._1.ctor === 'Just')) {
							return A2(
								_minond$brainloller$Main$BackCurr,
								back,
								A4(_minond$brainloller$Brainloller_Pixel$setCellAt, resized, _p18, _p19, pixel));
						} else {
							return _p17;
						}
					}();
			...
			case 'IncreaseSize':
				var _p20 = _p3._1.boardDimensions;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'DecreaseSize':
				var _p21 = _p3._1.boardDimensions;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							boardDimensions: {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Tuple$first(_p21) - 1,
								_1: _elm_lang$core$Tuple$second(_p21) - 1
							}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
if (typeof _minond$brainloller$Main$main !== 'undefined') {
    _minond$brainloller$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"Redo":[],"WriteCmd":["Int","Int","Bool"],"DecreaseSize":[],"Tick":["Brainloller.Lang.BLRuntime"],"ImageProcessed":["Brainloller.Lang.BLProgram"],"Start":[],"ZoomIn":[],"DownloadProgram":[],"ZoomOut":[],"Halt":["Brainloller.Lang.BLRuntime"],"EnableWrite":[],"UploadProgram":[],"Pause":[],"Reset":[],"SetSpeed":["String"],"Undo":[],"SetCmd":["Brainloller.Lang.BLOptCode"],"LoadMemoryProgram":["String"],"NoOp":[],"DisableWrite":[],"Continue":[],"IncreaseSize":[]}}},"aliases":{"Brainloller.Lang.BLProgram":{"args":[],"type":"List (List Brainloller.Lang.Pixel)"},"Brainloller.Lang.Pixel":{"args":[],"type":"{ r : Int, g : Int, b : Int }"},"Brainloller.Lang.BLRuntime":{"args":[],"type":"{ activeCoor : ( Int, Int ) , activeCell : Int , jumps : List ( Int, Int, Int ) , pointerDeg : Int , output : Maybe.Maybe String , input : Maybe.Maybe String , memory : List Int }"},"Brainloller.Lang.BLOptCode":{"args":[],"type":"String"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
