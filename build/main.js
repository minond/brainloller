	...
	_0: _minond$brainloller$Editor$textCopy(
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A3(_minond$brainloller$Editor$link, 'Brainfuck', 'http://minond.xyz/brainfuck', false),
					_1: {
						ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: A3(_minond$brainloller$Editor$link, 'infinity', 'https://en.wikipedia.org/wiki/Infinity', true),
							_1: {
								ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _minond$brainloller$Editor$textCopy(_minond$brainloller$Main$introText2),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
